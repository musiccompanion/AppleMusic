    ...
    public function album(Album\Id $id): Album
    {
        ...
        return new Album(
            ...
            \array_key_exists('artwork', $attributes) ? new Artwork(
                ...
                $bgColor ? RGBA::of($bgColor) : null,
                $textColor1 ? RGBA::of($textColor1) : null,
                $textColor2 ? RGBA::of($textColor2) : null,
                $textColor3 ? RGBA::of($textColor3) : null,
                $textColor4 ? RGBA::of($textColor4) : null,
            ) : null,
